...
def main() -> None:
    ...
    ap.add_argument(
        "--root",
        default="/home/liyuanqiu/OpenROAD-flow-scripts/tools/OpenROAD/src/rcx/calibration/fasterCap/5v2_typ_widened",
    ...
    ap.add_argument(
        "--converter",
        default="/home/liyuanqiu/OpenROAD-flow-scripts/tools/OpenROAD/src/rcx/calibration/fasterCap/scripts/UniversalFormat2FasterCap_923.py",
    )
