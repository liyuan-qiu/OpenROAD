...
def main() -> None:
    typ_root = Path(
        "/home/liyuanqiu/OpenROAD-flow-scripts/tools/OpenROAD/src/rcx/calibration/fastercapnangate45/5v2_typ/TYP"
    )
    fastercap = Path(
        "/home/liyuanqiu/OpenROAD-flow-scripts/tools/OpenROAD/src/rcx/calibration/fastercapnangate45/bin/FasterCap"
    )
    out_dir = Path(
        "/home/liyuanqiu/OpenROAD-flow-scripts/tools/OpenROAD/src/rcx/calibration/fastercapnangate45/model/typ542_ps128_g_a0p1_t0p1_to180"
    )
