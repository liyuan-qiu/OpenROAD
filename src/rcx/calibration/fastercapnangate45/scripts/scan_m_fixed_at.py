...
def main() -> None:
    ...
    ap.add_argument(
        "--base-dir",
        default="/home/liyuanqiu/OpenROAD-flow-scripts/tools/OpenROAD/src/rcx/calibration/fastercapnangate45/5v2_typ/TYP",
    )
    ap.add_argument(
        "--fastercap-bin",
    ...
    ap.add_argument(
        "--out-dir",
        default="/home/liyuanqiu/OpenROAD-flow-scripts/tools/OpenROAD/src/rcx/calibration/fastercapnangate45/model/m_scan_a0p1_t0p1",
    )
    args = ap.parse_args()
